...
- [commentary](https://github.com/hdb/commentary/blob/master/commentary/commentary_filter.py): a Pandoc filter and command line tool that preserves native-style comments + metadata between Markdown/docx conversions.
